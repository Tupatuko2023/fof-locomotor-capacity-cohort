...
| `PROJECT_SPECIFICATION_TEMPLATE.md` | P0 | template | Define the structure and fields of a later project specification | `template-only` | Load only when drafting a project specification | `KB_INDEX.md`, `SAFETY_PRIVACY_GUARDRAILS.md`, `TOOL_AND_AGENT_POLICY.md`, `EVIDENCE_REVIEW_AND_ACCEPTANCE.md`, `RESEARCH_REPOSITORY_PATTERNS.md` | `template` | `approved` | `validated` | `FARO1 Knowledge Steward` | `User / designated project owner` |
